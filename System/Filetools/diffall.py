"""
##############################################################################
Usage: "python difall.py dir1 dir2"
Recursive directory tree comparison: report unique files that exist only in
...
os.listdir() calss in dirdiff.comparedirs() by passing results here along.
"""
...
def comparetrees(dir1, dir2, diffs, verbose=False):
    ...
    as tress might contain arbitrary binary files as well as arbitrary text;
